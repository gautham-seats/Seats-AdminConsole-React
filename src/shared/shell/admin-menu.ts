...
export const DEVELOPER_KEYS_ROUTE = '/users/developer-keys'
export const SETTINGS_ROUTE = '/settings'
export const AUTHENTICATION_ROUTE = '/settings/authentication'
export const GRAPH_API_ROUTE = '/settings/graph-api'
export const CONTACTS_ROUTE = '/settings/contacts'
export const FILE_TEMPLATES_ROUTE = '/settings/file-templates'
export const ACTIVITY_TYPES_ROUTE = '/settings/activity-types'
export const RESOURCES_ROUTE = '/settings/resources'
...
export const READINGS_REPORT_ROUTE = '/resources/readings-report'
export const SUSPICIOUS_READINGS_ROUTE = '/resources/suspicious-readings-report'
export const ROLLBACK_ROUTE = '/rollback'
...
export const ENGAGEMENT_HISTORY_ROUTE = '/engagement/history'
export const CASE_ROUTE = '/case'
export const STUDENT_WORKFLOW_ROUTE = '/case/student-workflow'
...
export const NOTIFICATIONS_LEGACY_ROUTE = '#/UserNotification'
