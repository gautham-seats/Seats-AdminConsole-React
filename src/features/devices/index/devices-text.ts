...
export const DEVICES_FALLBACK_ONLY = {
  ...
  exporting: 'Exporting',
  noValue: '—',
  roomDevicesHint: 'Every device assigned to this room, active or not.',
  roomTimetableTitle: 'Timetable needs a backend endpoint',
  roomTimetableBody:
    'No Admin API returns the lectures booked into one room, so there is nothing to show here yet.',
  roomActivityTitle: 'Activity needs a filter the audit API does not have',
  roomActivityBody:
    'The audit search filters by site, type, user and date, but not by one room, so this room’s history cannot be listed here yet.',
  openActivityLog: 'Open Activity Log',
  devicesPerSeat: 'Devices per seat',
  lowestBattery: 'Lowest battery',
  staleReading: 'No recent reading',
  activeLower: 'active',
  ...
  locationHint: 'Which building this room sits in.',
  identificationHint: 'How the room is named and referenced everywhere else.',
  capacityHint: "Used to flag lectures booked beyond the room's seats.",
  locationGroup: 'Location',
  capacityGroup: 'Capacity',
  identification: 'Identification',
  network: 'Network',
  exportPrompt: 'Choose a file format for this device list.',
  ...
  // _IndexHeaderFilter.cshtml:53 caption "[all day]", without the brackets.
  allDay: 'All day',
